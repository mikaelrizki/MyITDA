...
export default function Tutorial({ isVisible, onClose }) {
  ...
  return (
    <View style={LOCAL_STYLE.modalContent}>
      <Text bold center fontsize={SIZES.LargeText} color={COLORS.black}>
        Cara Pembayaran SPP
      </Text>
      <View style={{ marginTop: 5 }}>
        <View>
          <Text bold color={COLORS.primary} fontsize={SIZES.mediumText}>
            Bank BNI (Transfer VA)
          </Text>
        </View>
      ...
      <View style={{ marginTop: 15 }}>
        <View>
          <Text bold color={COLORS.darkBlue} fontsize={SIZES.mediumText}>
            Kode Pembayaran lihat Kolom 'Kode BYR'
          </Text>
          <Text
            bold
            ...
            style={{ marginTop: -10 }}>
            *Jika terdapat kesalahan Data Pembayaran baik jumlah atau status
            bayar, Silahkan KONFIRMASI ke Biro Keuangan
          </Text>
        </View>
      </View>
    </View>
